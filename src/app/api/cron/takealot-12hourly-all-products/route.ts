  ...
  try {
    ...
    for (const integrationDoc of integrationsSnapshot.docs) {
      try {
        ...
        console.log(`Processing 12-hourly all products sync for integration: ${integrationId}`);
        ...
        console.log(`Completed 12-hourly all products sync for ${integrationId}:`, syncResult);
