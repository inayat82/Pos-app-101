          ...
          <div className="p-6">
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <h3 className="font-semibold text-blue-800 mb-2">📋 Testing Overview</h3>
                <p className="text-sm text-blue-700 mb-3">
                  This test will run all 4 sync strategies systematically and provide detailed performance metrics:
                </p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                  <div className="bg-white p-2 rounded border">
                    <div className="font-medium text-blue-800">🚀 Last 100</div>
                    <div className="text-blue-600">Smart comparison</div>
                    <div className="text-gray-600">~1 page, 5-15s</div>
                  </div>
                  <div className="bg-white p-2 rounded border">
                    <div className="font-medium text-blue-800">📅 Last 30 Days</div>
                    <div className="text-blue-600">Date filtered</div>
                    <div className="text-gray-600">~5-20 pages, 30-90s</div>
                  </div>
                  <div className="bg-white p-2 rounded border">
                    <div className="font-medium text-blue-800">📊 Last 6 Months</div>
                    <div className="text-blue-600">Chunked processing</div>
                    <div className="text-gray-600">~50-200 pages, 5-15m</div>
                  </div>
                  <div className="bg-white p-2 rounded border">
                    <div className="font-medium text-blue-800">🗄️ All Data</div>
                    <div className="text-blue-600">Progressive chunks</div>
                    <div className="text-gray-600">~200+ pages, 15-60m</div>
                  </div>
                </div>
              </div>
